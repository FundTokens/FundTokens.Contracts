...
describe('encoded Bitcoin fee testing', () => {
    ...
    it('should create new encoded fee threads', async () => {
        ...
        await transaction.addCreateFundFee({ fee: { amount: 50000n }, signature });
        transaction.addInput(feeUtxo, systemOwnerWallet.signatureTemplate.unlockP2PKH());
        await transaction.addExecuteFundFee({ fee: { amount: 5000n }, signature });
